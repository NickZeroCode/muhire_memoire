      ...
      const feeder5 = document.getElementById("feeder-5");
      ...
      function renderCabines() {
        ...
        cabinesPrioritaires.forEach((cabine) => {
          ...
          const currentPriorityDivCount =  prioritaires.getElementsByTagName('h3').length;
          if (currentPriorityDivCount  < maxCabineSection) {
        ...
        normales.forEach((cabine) => {
          ...
          if (cabine.feeder === 1) {
            const currentDivCount = feeder1.getElementsByTagName('h3').length;
            if (currentDivCount < maxCabineSection) {
              feeder1.appendChild(cabineElement);
            }
            
          } else if (cabine.feeder === 2) {
            const currentDivCount = feeder2.getElementsByTagName('h3').length;
            if (currentDivCount < maxCabineSection) {
              feeder2.appendChild(cabineElement);
            }
          }
          else if (cabine.feeder === 3){
            const currentDivCount = feeder3.getElementsByTagName('h3').length;
            if (currentDivCount < maxCabineSection) {
              feeder3.appendChild(cabineElement);
            }
          }
          else if (cabine.feeder === 5){
            const currentDivCount = feeder5.getElementsByTagName('h3').length;
            if (currentDivCount < maxCabineSection) {
              feeder5.appendChild(cabineElement);
            }
          }
